Shader "PaintSim/Wet Paint Surface URP"
{
    Properties
    {
        ...
        _DryPaintSmoothness ("Dry Paint Smoothness", Range(0, 1)) = 0.46
        _WetPaintSmoothness ("Wet Paint Smoothness", Range(0, 1)) = 0.92
        _PaintNormalStrength ("Paint Thickness Normal", Range(0, 8)) = 3.25
        _ParallaxStrength ("Wet Film Parallax", Range(0, 0.04)) = 0.006
        _EdgeRidgeStrength ("Contact Edge Ridge", Range(0, 12)) = 5.0
        _EdgeDarkening ("Contact Edge Darkening", Range(0, 0.35)) = 0.07
        _MicroNormalStrength ("Paint Micro Normal", Range(0, 0.25)) = 0.045
        _CanvasGrainStrength ("Canvas Grain Strength", Range(0, 0.25)) = 0.070
        _CanvasGrainScale ("Canvas Grain Scale", Range(8, 512)) = 155
        _PigmentSaturation ("Pigment Saturation", Range(0.6, 1.6)) = 1.08
        _WetDarkening ("Wet Pigment Darkening", Range(0, 0.25)) = 0.065
        _EdgeHighlightStrength ("Wet Edge Highlight", Range(0, 1.2)) = 0.30
        _WetSpecularStrength ("Wet Specular Strength", Range(0, 2)) = 0.88
        _ClearCoatStrength ("Wet Clear Coat", Range(0, 1.5)) = 0.72
        _EnvironmentReflection ("Environment Reflection", Range(0, 2)) = 0.46
